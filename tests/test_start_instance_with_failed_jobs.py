...
# Workflow
def test_user_start_instance_and_process_one_batch_of_jobs_that_end_up_failing():
    file = os.path.dirname(os.path.abspath(__file__)) + '/files/invalid_func_python36.py'
    parameters = '((1,),(2,),(3,))'
    ...
    r, job_uuids = TestWrapper.check_list_jobs_output(
        expected_status=['FAILED', 'FAILED', 'FAILED'],
        expected_num_jobs=3
    )
